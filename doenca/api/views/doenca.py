...
from doenca.api.serializers.doenca import DoencaSerializer


class DoencaViewAPI(ModelViewSet):
...
class DoencaReadOnlyAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
